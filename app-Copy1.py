...
def show_loading_page():
    ...
    img = Image.open("C:/Users/Julian Amuedo/Desktop/Viera Financial Solutions/Logo/Logo/High Resolution Logo Files/Grayscale on Transparent.png")
    # Convert the image to bytes
    img_bytes = io.BytesIO()
    img.save(img_bytes, format="PNG")
    # Display the image
    st.image(img_bytes, use_column_width=True)
    # Centered loading message with dark+ theme
...
def main():
    ...
    # Generate random symbols for different portfolio sizes
    random_symbols_10 = generate_random_symbols(10)
    random_symbols_20 = generate_random_symbols(20)
    random_symbols_30 = generate_random_symbols(30)

    #st.subheader("Precios históricos de los 10 activos")
    price_data_10 = download_price_data(random_symbols_10, '2016-01-01', '2024-02-18')
    #st.write(price_data_10)

    #st.subheader("Precios históricos de los 20 activos")
    price_data_20 = download_price_data(random_symbols_20, '2016-01-01', '2024-02-18')
    #st.write(price_data_20)

    #st.subheader("Precios históricos de los 30 activos")
    price_data_30 = download_price_data(random_symbols_30, '2016-01-01', '2024-02-18')
    #st.write(price_data_30)
    ...
    # Streamlit UI
#     st.title("Daily Log Returns and Portfolio Metrics")

#     # Display daily log returns
#     st.header("Daily Log Returns")
#     st.write("10 Symbols:")
#     st.write(log_ret_10)
...
#     st.write("10 Symbols:")
#     st.write("Mean Return:", mean_ret_10)
#     st.write("Covariance Matrix:")
#     st.write(cov_mat_10)

#     st.write("20 Symbols:")
#     st.write("Mean Return:", mean_ret_20)
#     st.write("Covariance Matrix:")
#     st.write(cov_mat_20)

#     st.write("30 Symbols:")
#     st.write("Mean Return:", mean_ret_30)
#     st.write("Covariance Matrix:")
#     st.write(cov_mat_30)
...
#     st.write("Results for 10 symbols:")
#     st.write("Portfolio Returns:", port_returns_10)
#     st.write("Portfolio Risk:", port_risk_10)
#     st.write("Sharpe Ratio:", sharpe_ratio_10)

#     st.write("\nResults for 20 symbols:")
#     st.write("Portfolio Returns:", port_returns_20)
#     st.write("Portfolio Risk:", port_risk_20)
#     st.write("Sharpe Ratio:", sharpe_ratio_20)

#     st.write("\nResults for 30 symbols:")
#     st.write("Portfolio Returns:", port_returns_30)
#     st.write("Portfolio Risk:", port_risk_30)
#     st.write("Sharpe Ratio:", sharpe_ratio_30)
...
#         st.write("Portfolio Metrics for 10 symbols:")
#         st.write("Portfolio Returns:", port_returns_10)
#         st.write("Portfolio Risk:", port_risk_10)
#         st.write("Sharpe Ratio:", sharpe_ratio_10)

#         st.write("\nPortfolio Metrics for 20 symbols:")
#         st.write("Portfolio Returns:", port_returns_20)
#         st.write("Portfolio Risk:", port_risk_20)
#         st.write("Sharpe Ratio:", sharpe_ratio_20)

#         st.write("\nPortfolio Metrics for 30 symbols:")
#         st.write("Portfolio Returns:", port_returns_30)
#         st.write("Portfolio Risk:", port_risk_30)
#         st.write("Sharpe Ratio:", sharpe_ratio_30)
    ...
    # Display the weights of the minimum variance portfolio and the tangency portfolio for each case
#     st.write("Ponderaciones del Portafolio de Mínima Varianza (10 symbols):")
#     for i in range(len(random_symbols_10)):
#         st.write(random_symbols_10[i] + ": " + str(weights_min_var_perc_10[i]) + "%")

#     st.write("Ponderaciones del Portafolio de Tangencia (10 symbols):")
#     for i in range(len(random_symbols_10)):
#         st.write(random_symbols_10[i] + ": " + str(weights_max_sr_perc_10[i]) + "%")

#     st.write("Ponderaciones del Portafolio de Mínima Varianza (20 symbols):")
#     for i in range(len(random_symbols_20)):
#         st.write(random_symbols_20[i] + ": " + str(weights_min_var_perc_20[i]) + "%")

#     st.write("Ponderaciones del Portafolio de Tangencia (20 symbols):")
#     for i in range(len(random_symbols_20)):
#         st.write(random_symbols_20[i] + ": " + str(weights_max_sr_perc_20[i]) + "%")

#     st.write("Ponderaciones del Portafolio de Mínima Varianza (30 symbols):")
#     for i in range(len(random_symbols_30)):
#         st.write(random_symbols_30[i] + ": " + str(weights_min_var_perc_30[i]) + "%")

#     st.write("Ponderaciones del Portafolio de Tangencia (30 symbols):")
#     for i in range(len(random_symbols_30)):
#         st.write(random_symbols_30[i] + ": " + str(weights_max_sr_perc_30[i]) + "%")
        
    # Display portfolio statistics
    #st.header("Estadísticas de los distintos portafolios")

    # Display statistics for the 10-asset portfolio
    #st.subheader("Portfolio de 10 activos")
    #st.write("Calculando estadísticos para el portafolio de 10 activos")
    ...
    # Display statistics for the 20-asset portfolio
    #st.subheader("Portfolio de 20 activos")
    #st.write("Calculando los estadísticos para el portafolio de 20 activos")
    ...
    # Function to plot a portfolio as an interactive bar chart
    ...
    # Display the tickers for each customized portfolio
    # st.write("Tickers for Customized Portfolio (10 Symbols):", tickers_10_symbols_personalizado)
    # st.write("Tickers for Customized Portfolio (20 Symbols):", tickers_20_symbols_personalizado)
    # st.write("Tickers for Customized Portfolio (30 Symbols):", tickers_30_symbols_personalizado)

    # Fetch prices for each customized portfolio
    price_data_10_symbols_personalizado = fetch_prices(tickers_10_symbols_personalizado, '2018-01-01', '2024-01-01')
    price_data_20_symbols_personalizado = fetch_prices(tickers_20_symbols_personalizado, '2018-01-01', '2024-01-01')
    price_data_30_symbols_personalizado = fetch_prices(tickers_30_symbols_personalizado, '2018-01-01', '2024-01-01')

    # Display the fetched price data
#     st.write("Price data for Customized Portfolio (10 Symbols):")
#     st.write(price_data_10_symbols_personalizado.head())

#     st.write("Price data for Customized Portfolio (20 Symbols):")
#     st.write(price_data_20_symbols_personalizado.head())

#     st.write("Price data for Customized Portfolio (30 Symbols):")
#     st.write(price_data_30_symbols_personalizado.head())
    ...
    # Display the weights of assets in each portfolio
#     st.write("Weights of assets in Customized Portfolio (10 Symbols):")
#     st.dataframe(df_10)

#     st.write("Weights of assets in Customized Portfolio (20 Symbols):")
#     st.dataframe(df_20)

#     st.write("Weights of assets in Customized Portfolio (30 Symbols):")
#     st.dataframe(df_30)
    ...
    # Display the returns of each portfolio
#     st.write("\nReturns of Customized Portfolio (10 Symbols):")
#     st.write(returns_10_symbols_personalizado.head())

#     st.write("\nReturns of Customized Portfolio (20 Symbols):")
#     st.write(returns_20_symbols_personalizado.head())

#     st.write("\nReturns of Customized Portfolio (30 Symbols):")
#     st.write(returns_30_symbols_personalizado.head())
    ...
    cumulative_returns_30 = returns_30_symbols_personalizado.cumsum()
     ...
     # Display the cumulative returns of each portfolio
    #st.write("\nRetorno acumulado del portafolio personalizado (10 acciones):", cumulative_returns_10)
    #st.write("Retorno acumulado del portafolio personalizado (20 acciones):", cumulative_returns_20)
    #st.write("Retorno acumulado del portafolio personalizado (30 acciones):", cumulative_returns_30)
